...
def shop(request):
    ...
    return HttpResponse(template.render({'title': 'Shop'}, request))
...
def detail(request, pid):
    if request.method == 'GET':
        ...
        context = {'product': product, 'title':'product:'+product.sku}
...
def cart(request):
    ...
    return HttpResponse(template.render({'title': 'Cart'}, request))
def checkout(request):
    if request.method == 'GET':
        template = loader.get_template('checkout.html')
        return HttpResponse(template.render({'title': 'Checkout'}, request))
...
def profile(request):
    ...
    return HttpResponse(template.render({'title': 'Profile'}, request))
